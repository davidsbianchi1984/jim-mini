...
const TABLE: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "cch.speaking.hush": {
    en: "speaking — it will listen again after, or tap to end the conversation", es: "hablando — después volverá a escuchar, o toca para terminar la conversación", fr: "parle — il écoutera de nouveau ensuite, ou touchez pour terminer la conversation", de: "spricht — danach hört es wieder zu; oder tippen, um das Gespräch zu beenden", pt: "a falar — depois volta a ouvir, ou toque para terminar a conversa", it: "sta parlando — poi tornerà in ascolto, o tocca per chiudere la conversazione", ja: "話しています — 話し終えるとまた聞き始めます。タップで会話を終了", zh: "正在说话 — 说完后会继续聆听，或点按结束对话", hi: "बोल रहा है — इसके बाद फिर सुनेगा, या बातचीत समाप्त करने के लिए टैप करें", ar: "يتحدث — سيستمع مجددًا بعدها، أو انقر لإنهاء المحادثة",
  },
  "cch.prov.online": {
