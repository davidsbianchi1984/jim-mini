...
NOT_A_CLIENT_CALL = (
    ...
    # The reach-out cascade's call handlers (jim/reachout.py). The voice
    # sidecar (docker/voice in the QRME stack) turns these when a contact
    # answers, presses a key, speaks, or the line drops — the same
    # machine-facing shape as the far-end acknowledgment above, keyed on an
    # opaque call id the house carries back, behind JIM_VOICE_SECRET. No
    # client of this product constructs them, and none should: the
